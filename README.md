...
**Предусловия**: Сгенерировать данные для таблиц сообщений и пользователей <br>
...
## Сборка
Сборка и запуск всех компонентов приложения, включая тесты, осуществляется путем запуска файла launch.bat, лежащего в корне репозитория.
